...
| --- | --- | --- |
| UC-01 | Se registra la compra de 10 sacos de harina en USD ($30.00 c/u) un día feriado. | El sistema valida la fecha de la factura. Extrae de la caché local o API el Tipo de Cambio Oficial del BCN de ese día. Traduce el costo a Córdobas (ej. $30.00 × 36.6542 = C$1,099.626 por saco) y aplica el algoritmo de CPP actualizando el maestro de insumos. |
