import {
  SpendPointsStrategy,
  ProductStampsStrategy,
  VisitStampsStrategy,
} from './earning-strategy';
      ...
      lines: [
        {
          ...
          productId: 'p1',
          quantity: 1,
          merchandiseNetNioAfterAllBenefits: 5,
          source: 'NORMAL',
        },
      ],
    });
      ...
      lines: [
        {
          ...
          productId: 'p1',
          quantity: 1,
          merchandiseNetNioAfterAllBenefits: 250,
          source: 'NORMAL',
        },
      ],
    });
      ...
      lines: [
        {
          ...
          productId: 'p1',
          quantity: 1,
          merchandiseNetNioAfterAllBenefits: 99,
          source: 'NORMAL',
        },
      ],
    });
      ...
      lines: [
        {
          ...
          productId: 'p1',
          quantity: 1,
          merchandiseNetNioAfterAllBenefits: 200,
          source: 'NORMAL',
        },
        {
          lineId: 'l2',
      ...
      lines: [
        {
          ...
          productId: 'p1',
          quantity: 1,
          merchandiseNetNioAfterAllBenefits: 60,
          source: 'NORMAL',
        },
        {
          lineId: 'l2',
          productId: 'p2',
          quantity: 1,
          merchandiseNetNioAfterAllBenefits: 40,
          source: 'NORMAL',
        },
      ],
    });
    const program = makeProgram({
      earning_rule: { spendBlockNio: 10, pointsPerBlock: 2 },
    });
    const result = strategy.evaluate(snapshot, program);
    expect(result.units).toBe(20);
  });
    ...
    const snapshot = makeSnapshot({
      lines: [
        ...
        },
        {
          ...
          productId: 'prod-2',
          quantity: 2,
          merchandiseNetNioAfterAllBenefits: 20,
          source: 'NORMAL',
        },
      ],
    });
      ...
      lines: [
        {
          ...
          productId: 'prod-1',
          quantity: 2.5,
          merchandiseNetNioAfterAllBenefits: 25,
          source: 'NORMAL',
        },
      ],
    });
    ...
    const snapshot = makeSnapshot({
      lines: [
        ...
        },
        {
          ...
          categoryId: 'cat-2',
          quantity: 1,
          merchandiseNetNioAfterAllBenefits: 10,
          source: 'NORMAL',
        },
      ],
    });
      ...
      lines: [
        {
          ...
          productId: 'p1',
          quantity: 1,
          merchandiseNetNioAfterAllBenefits: 15,
          source: 'NORMAL',
        },
      ],
    });
