...
/**
 * Forces tenant row level security on the onboarding template/provenance
 * tables (issue #493 T2.S3a):
 ...
 *   uuid after the rebind migrations (1809080000000, 1809140000000), but a
 ...
 * - No service binding belongs to this slice (T2.S3a is policies only);
...
export class EnforceOnboardingTemplateRls1809230000000 implements MigrationInterface {
  name = 'EnforceOnboardingTemplateRls1809230000000';
