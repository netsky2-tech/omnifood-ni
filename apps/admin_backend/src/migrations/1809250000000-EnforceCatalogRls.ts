...
/**
 * Forces tenant row level security on the catalog tables `products` and
 * `insumos` (issue #512 T3.S1 part B).
 *
 ...
 * - No service binding belongs to this migration: part A of T3.S1 already
...
export class EnforceCatalogRls1809250000000 implements MigrationInterface {
  name = 'EnforceCatalogRls1809250000000';
