  ...
  try {
    ...
    const recipeService = new RecipeService(
      ...
      dataSource.getRepository(
        (await import('../../src/modules/inventory/entities/uom-conversion.entity')).UomConversion,
      ),
      new (await import('../../src/modules/inventory/uom-conversion-calculator')).UomConversionCalculator(),
      dataSource,
    );

    const productService = new ProductService(
      dataSource,
      { log: jest.fn() } as unknown as ChangeLogService,
    );
    ...
    await assertion({ app, dataSource, jwtService, tenantId, recipeService, productService });
  } finally {
...
describe('RecipeController E2E — real PostgreSQL', () => {
  ...
  describe('POST /recipes/products/:productId/versions', () => {
    it(
      ...
      async () => {
        await withIsolatedSchema('e2e_recipe_create', async ({
          app,
          dataSource,
          jwtService,
          tenantId,
    ...
    it(
      ...
      async () => {
        await withIsolatedSchema('e2e_recipe_create_400', async ({
          app,
          jwtService,
          tenantId,
        }) => {
    ...
    it(
      ...
      async () => {
        await withIsolatedSchema('e2e_recipe_create_mismatch', async ({
          app,
          jwtService,
          tenantId,
        }) => {
    ...
    it(
      ...
      async () => {
        await withIsolatedSchema('e2e_recipe_create_403', async ({
          app,
          jwtService,
          tenantId,
        }) => {
  ...
  describe('GET /recipes/products/:productId/active', () => {
    it(
      ...
      async () => {
        await withIsolatedSchema('e2e_recipe_get_active', async ({
          app,
          dataSource,
          jwtService,
          tenantId,
          ...
          expect(res.body.recipeVersion).toBeDefined();
          expect(res.body.recipeVersion.id).toBe(createRes.body.recipeVersion.id);
          expect(res.body.recipeVersion.product_id).toBe(productId);
          expect(res.body.recipeVersion.version_number).toBe(1);
          expect(res.body.recipeVersion.is_active).toBe(true);
    ...
    it(
      ...
      async () => {
        await withIsolatedSchema('e2e_recipe_get_active_empty', async ({
          app,
          dataSource,
          jwtService,
          tenantId,
    ...
    it(
      ...
      async () => {
        await withIsolatedSchema('e2e_recipe_get_active_401', async ({
          app,
        }) => {
          await request(app.getHttpServer())
  ...
  describe('GET /recipes/:recipeVersionId/snapshot', () => {
    it(
      ...
      async () => {
        await withIsolatedSchema('e2e_recipe_snapshot', async ({
          app,
          dataSource,
          jwtService,
          tenantId,
    ...
    it(
      ...
      async () => {
        await withIsolatedSchema('e2e_recipe_snapshot_404', async ({
          app,
          jwtService,
          tenantId,
        }) => {
  ...
  describe('Tenant isolation', () => {
    it(
      ...
      async () => {
        await withIsolatedSchema('e2e_recipe_tenant_isolation', async ({
          app,
          dataSource,
          jwtService,
          tenantId,
          ...
          await dataSource.query(
            ...
            [randomUUID(), otherTenantId, otherRecipeVersionId, otherInsumoId],
          );
  ...
  describe('Version management', () => {
    it(
      ...
      async () => {
        await withIsolatedSchema('e2e_recipe_versioning', async ({
          app,
          dataSource,
          jwtService,
          tenantId,
          ...
          expect(v2Res.body.recipeVersion.version_note).toBe('Version 2 - mejorada');
          ...
          expect(activeRes.body.recipeVersion.id).toBe(v2Res.body.recipeVersion.id);
        });
      },
      TEST_TIMEOUT_MS,
    );
