...
class DatabaseSeeder {
  static Future<void> seedAll(AppDatabase database, {bool force = false}) async {
    ...
    if (!force && existingUsers.isNotEmpty && existingProducts.isNotEmpty) {
      return;
    }
    ...
    // 2. Catalog Values (UOM, Categories, Product Types)
    final catalogValues = <CatalogValueEntity>[
      ...
      CatalogValueEntity(id: 'cat-uom-l', catalogType: 'uom', code: 'L', name: 'Litro', sortOrder: 4),
      CatalogValueEntity(id: 'cat-uom-ml', catalogType: 'uom', code: 'ml', name: 'Mililitro', sortOrder: 5),
      CatalogValueEntity(id: 'cat-uom-un', catalogType: 'uom', code: 'un', name: 'Unidad', sortOrder: 6),
      CatalogValueEntity(id: 'cat-uom-oz', catalogType: 'uom', code: 'oz', name: 'Onza', sortOrder: 7),
      CatalogValueEntity(id: 'cat-pcat-calientes', catalogType: 'productCategory', code: 'BEB-CAL', name: 'Bebidas Calientes', sortOrder: 1),
      CatalogValueEntity(id: 'cat-pcat-frias', catalogType: 'productCategory', code: 'BEB-FRI', name: 'Bebidas Frías', sortOrder: 2),
      CatalogValueEntity(id: 'cat-pcat-desayunos', catalogType: 'productCategory', code: 'DESAYUNOS', name: 'Desayunos', sortOrder: 3),
      CatalogValueEntity(id: 'cat-pcat-comidas', catalogType: 'productCategory', code: 'COMIDAS', name: 'Comidas', sortOrder: 4),
      CatalogValueEntity(id: 'cat-pcat-postres', catalogType: 'productCategory', code: 'POSTRES', name: 'Postres', sortOrder: 5),
      CatalogValueEntity(id: 'cat-ptype-prep', catalogType: 'salesProductType', code: 'PREPARADO', name: 'Preparado en Barra/Cocina', sortOrder: 1),
      CatalogValueEntity(id: 'cat-ptype-rev', catalogType: 'salesProductType', code: 'REVENTA', name: 'Reventa Comercial', sortOrder: 2),
    ];
    ...
    final insumos = <InsumoEntity>[
      ...
      InsumoEntity(id: 'INS-08', name: 'Vaso Térmico 12oz con Tapa', consumptionUom: 'un', warehouseId: 'BOD-02', stock: 220.0, averageCost: 3.50, parLevel: 350.0, stockMin: 50.0, stockMax: 500.0),
      InsumoEntity(id: 'INS-09', name: 'Vaso Térmico 16oz con Tapa', consumptionUom: 'un', warehouseId: 'BOD-02', stock: 175.0, averageCost: 4.20, parLevel: 300.0, stockMin: 40.0, stockMax: 400.0),
    ...
    final products = <ProductEntity>[
      ProductEntity(id: 'PROD-01', name: 'Café Americano', uom: 'un', stock: 100.0, averageCost: 12.50, sellPrice: 60.0, sku: 'CAF-AME-01', category: 'Bebidas Calientes', isPrepared: true),
      ProductEntity(id: 'PROD-02', name: 'Cappuccino Artesanal', uom: 'un', stock: 100.0, averageCost: 22.00, sellPrice: 85.0, sku: 'CAF-CAP-01', category: 'Bebidas Calientes', isPrepared: true),
      ProductEntity(id: 'PROD-03', name: 'Desayuno Típico Nica', uom: 'un', stock: 50.0, averageCost: 42.00, sellPrice: 130.0, sku: 'DES-TIP-01', category: 'Desayunos', isPrepared: true),
      ProductEntity(id: 'PROD-04', name: 'Quesillo Doble Especial', uom: 'un', stock: 50.0, averageCost: 31.00, sellPrice: 95.0, sku: 'COM-QUE-01', category: 'Comidas', isPrepared: true),
      ProductEntity(id: 'PROD-05', name: 'Nacatamal de Cerdo Tradicional', uom: 'un', stock: 30.0, averageCost: 48.00, sellPrice: 120.0, sku: 'COM-NAC-01', category: 'Comidas', isPrepared: true),
      ProductEntity(id: 'PROD-06', name: 'Jugo Natural de Pitahaya', uom: 'un', stock: 60.0, averageCost: 16.00, sellPrice: 55.0, sku: 'BEB-PIT-01', category: 'Bebidas Frías', isPrepared: true),
      ProductEntity(id: 'PROD-07', name: 'Pastel Tres Leches Artesanal', uom: 'un', stock: 25.0, averageCost: 28.00, sellPrice: 90.0, sku: 'POS-3LE-01', category: 'Postres', isPrepared: true),
      ProductEntity(id: 'PROD-08', name: 'Agua Purificada 600ml', uom: 'un', stock: 80.0, averageCost: 12.00, sellPrice: 30.0, sku: 'BEB-AGU-01', category: 'Bebidas Frías', isPrepared: false),
    ];
    ...
    final recipeDocs = <RecipeVersionDocumentEntity>[
      RecipeVersionDocumentEntity(
        ...
        componentsJson: jsonEncode([
          {'ingredient_id': 'INS-01', 'ingredient_name': 'Café en Grano Matagalpa', 'ingredient_type': 'raw_material', 'gross_quantity': 0.018, 'net_quantity': 0.018, 'technical_shrink_pct': 0.0, 'unit_cost_nio': 180.0},
          {'ingredient_id': 'INS-08', 'ingredient_name': 'Vaso Térmico 12oz', 'ingredient_type': 'raw_material', 'gross_quantity': 1.0, 'net_quantity': 1.0, 'technical_shrink_pct': 0.0, 'unit_cost_nio': 3.50},
        ]),
        isSynced: true,
      ),
      RecipeVersionDocumentEntity(
        ...
        componentsJson: jsonEncode([
          {'ingredient_id': 'INS-01', 'ingredient_name': 'Café en Grano Matagalpa', 'ingredient_type': 'raw_material', 'gross_quantity': 0.018, 'net_quantity': 0.018, 'technical_shrink_pct': 0.0, 'unit_cost_nio': 180.0},
          {'ingredient_id': 'INS-02', 'ingredient_name': 'Leche Entera La Perfecta', 'ingredient_type': 'raw_material', 'gross_quantity': 0.20, 'net_quantity': 0.20, 'technical_shrink_pct': 0.0, 'unit_cost_nio': 38.00},
          {'ingredient_id': 'INS-08', 'ingredient_name': 'Vaso Térmico 12oz', 'ingredient_type': 'raw_material', 'gross_quantity': 1.0, 'net_quantity': 1.0, 'technical_shrink_pct': 0.0, 'unit_cost_nio': 3.50},
        ]),
        isSynced: true,
      ),
