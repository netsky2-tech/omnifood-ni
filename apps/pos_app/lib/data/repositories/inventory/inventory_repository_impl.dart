...
class InventoryRepositoryImpl
  ...
  RecipeVersionDocument _toRecipeVersionDocument(
    ...
    return RecipeVersionDocument(
      ...
      productName: entity.productName.isNotEmpty ? entity.productName : 'Producto',
      ...
      publishedAt: entity.publishedAt == null
          ? null
          : DateTime.tryParse(entity.publishedAt!),
  ...
  ProductionOrderDocument _toProductionOrderDocument(
    ...
    return ProductionOrderDocument(
      ...
      recipeProductName: entity.recipeProductName.isNotEmpty ? entity.recipeProductName : 'Producto',
      producedInsumoId: entity.producedInsumoId,
      producedInsumoName: entity.producedInsumoName.isNotEmpty ? entity.producedInsumoName : 'Insumo',
      plannedQuantity: entity.plannedQuantity,
      actualQuantity: entity.actualQuantity,
      producedBatchNumber: entity.producedBatchNumber.isNotEmpty ? entity.producedBatchNumber : 'LOTE-1',
      producedExpirationDate: DateTime.tryParse(entity.producedExpirationDate) ?? DateTime.now(),
      operationDate: DateTime.tryParse(entity.operationDate) ?? DateTime.now(),
      status: entity.status.isNotEmpty ? entity.status : 'CLOSED',
      outcome: entity.outcome.isNotEmpty ? entity.outcome : 'COMPLETED',
      failureReason: entity.failureReason,
      terminalId: entity.terminalId.isNotEmpty ? entity.terminalId : 'TERM-LOCAL',
      ...
      closedAt: entity.closedAt == null
          ? null
          : DateTime.tryParse(entity.closedAt!),
