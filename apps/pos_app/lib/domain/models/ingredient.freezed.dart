...
abstract class $IngredientCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, String unitOfMeasure});
}
...
class _$IngredientImpl implements _Ingredient {
  const _$IngredientImpl(
      {required this.id, required this.name, required this.unitOfMeasure});
  ...
  @override
  String toString() {
    return 'Ingredient(id: $id, name: $name, unitOfMeasure: $unitOfMeasure)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, unitOfMeasure);
...
abstract class _Ingredient implements Ingredient {
  const factory _Ingredient(
      ...
      required final String unitOfMeasure}) = _$IngredientImpl;
