...
class _$SupplierImpl implements _Supplier {
  ...
  @override
  String toString() {
    return 'Supplier(id: $id, name: $name, phone: $phone, contactPerson: $contactPerson, creditTerms: $creditTerms, isActive: $isActive)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, phone, contactPerson, creditTerms, isActive);
