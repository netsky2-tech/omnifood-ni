...
_$PrinterConfigImpl _$$PrinterConfigImplFromJson(Map<String, dynamic> json) =>
    _$PrinterConfigImpl(
      ...
      dgiAuthorizationCode: json['dgiAuthorizationCode'] as String?,
      dgiAuthorizationDate: json['dgiAuthorizationDate'] as String?,
      dgiAuthorizationDocument: json['dgiAuthorizationDocument'] as String?,
...
Map<String, dynamic> _$$PrinterConfigImplToJson(_$PrinterConfigImpl instance) =>
    <String, dynamic>{
      ...
      'dgiAuthorizationCode': instance.dgiAuthorizationCode,
      'dgiAuthorizationDate': instance.dgiAuthorizationDate,
      'dgiAuthorizationDocument': instance.dgiAuthorizationDocument,
